...
import { Search, Filter, Users, UserPlus, CreditCard as Edit, Trash2, Eye, Shield, CheckCircle, XCircle } from 'lucide-react';
...
const UserManagementView: React.FC = () => {
  ...
  const mockUsers: (User & { status: 'active' | 'inactive', last_login: string })[] = [
    {
      id: '1',
