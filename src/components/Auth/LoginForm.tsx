...
const LoginForm: React.FC<LoginFormProps> = ({ onBackToLanding }) => {
  const [isLogin, setIsLogin] = useState(true);
  const [email, setEmail] = useState('');
  const [password, setPassword] = useState('');
  const [confirmPassword, setConfirmPassword] = useState('');
  const [fullName, setFullName] = useState('');
  const [role, setRole] = useState<'student' | 'employer' | 'placement_officer'>('student');
                ...
                <>
                  ...
                  <div className="animate-slideDown">
                    ...
                    <select
                      ...
                      name="role"
                      value={role}
                      onChange={(e) => setRole(e.target.value as 'student' | 'employer' | 'placement_officer')}
